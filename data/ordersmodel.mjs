	...
	**/
	static initialize(database) {
		ModelUser.init({
			...
			"deliveredby"       : { type: DataTypes.ENUM(UserRole.User, UserRole.Admin), defaultValue: UserRole.User, allowNull: false },
			"suppid"   : { type: DataTypes.BOOLEAN,     allowNull: false, defaultValue: false }
		}, {
			"sequelize": database,
			"modelName": "Users",
			"hooks"    : {
